...
public class LanguageServiceImpl implements LanguageService {
    ...
    public LanguageResponse patch(Long id, LanguagePatchRequest request) {
        ...
        if (request.getLanguageCode() != null) entity.setLanguageCode(request.getLanguageCode());
        if (request.getName() != null) entity.setName(request.getName());
        if (request.getNativeName() != null) entity.setNativeName(request.getNativeName());
        if (request.getFlagUrl() != null) entity.setFlagUrl(request.getFlagUrl());
