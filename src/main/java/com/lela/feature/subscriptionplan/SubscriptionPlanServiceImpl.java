...
public class SubscriptionPlanServiceImpl implements SubscriptionPlanService {
    ...
    public SubscriptionPlanResponse patch(Long id, SubscriptionPlanPatchRequest request) {
        ...
        // Cập nhật từng trường thông tin nếu giá trị gửi lên khác null (Null-safe partial update)
        if (request.getPlanCode() != null) entity.setPlanCode(request.getPlanCode());
        ...
        if (request.getBillingCycle() != null) entity.setBillingCycle(request.getBillingCycle());
        if (request.getBillingIntervalCount() != null) entity.setBillingIntervalCount(request.getBillingIntervalCount());
        if (request.getMaxOwnedDecks() != null) entity.setMaxOwnedDecks(request.getMaxOwnedDecks());
        if (request.getMaxCardsPerDeck() != null) entity.setMaxCardsPerDeck(request.getMaxCardsPerDeck());
        if (request.getMaxDailyReviews() != null) entity.setMaxDailyReviews(request.getMaxDailyReviews());
        if (request.getQuizEnabled() != null) entity.setQuizEnabled(request.getQuizEnabled());
        if (request.getLeaderboardEnabled() != null) entity.setLeaderboardEnabled(request.getLeaderboardEnabled());
        if (request.getOfflineEnabled() != null) entity.setOfflineEnabled(request.getOfflineEnabled());
        if (request.getFeaturesJson() != null) entity.setFeaturesJson(request.getFeaturesJson());
